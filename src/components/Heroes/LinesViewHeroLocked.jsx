...
export default function LinesViewHeroLocked(props) {
    ...
    return <>
        <div className={styles.border_box_locked}>
            <div className={styles.line_box_locked}>
                <div className={'d-flex m-auto'}>
                    <div className={'m-auto position-relative'}>
                        <div className={styles[`rang${rang}`]}>
                            <img src={image} className={styles.line_img_lock}/>
                        </div>
                        <div className={styles.unlocked_border}>
                            <svg height='36vw' viewBox="0 0 304 304" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M302 152L274.017 179.983V274.017H179.983L152 302L124.017 274.017H29.9832V179.983L2 152L29.9832 124.017V29.9832H124.017L152 2L179.983 29.9832H274.017V124.017L302 152Z" stroke="#B28E4C" strokeWidth="5" strokeMiterlimit="10"/>
                            </svg>
                        </div>
                    </div>
                    <div className={'ms-4'}>
                        ...
                        <div className={styles.priceup_button_locked}>
                            <PriceUpButton priceUp={priceUp} text={'Призвать'}/>
                        </div>
