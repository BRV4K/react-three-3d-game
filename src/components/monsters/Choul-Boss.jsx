...
Command: npx gltfjsx@6.5.0 Choul-Boss.gltf 
*/
...
export default function Choul_Boss(props) {
  const group = React.useRef()
  const { scene, animations } = useGLTF('Choul-Boss/Choul-Boss.gltf')
  ...
  return (
    <group ref={group} {...props} dispose={null}>
      <group name="Choul-Boss">
        ...
        <directionalLight position={[0, -2, 1]} intensity={2.5} />
        <directionalLight position={[5, 7, -2]} intensity={3} />
        <directionalLight position={[-2, -1, 2]} intensity={1.5} />
        <directionalLight position={[0, 0.2, 3]} intensity={0.7} />
      </group>
    </group>
  )
}
